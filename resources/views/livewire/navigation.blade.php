        ...
        <x-container class="px-4 py-4">
           <div class="flex justify-between items-center space-x-8">
                ...
                <div class="flex-1 hidden md:block">
                    <x-input oninput="search(this.value)" class="w-full" placeholder="buscar por producto, tiendo o marca" />
                </div>
                    ...
                    <ul>
                        @foreach ($families as $family)
                            <li wire:mouseover="set('family_id',{{ $family->id }})">
                                <a href="{{ route('families.show',$family) }}" class=" flex justify-between items-center px-4 py-4 text-gray-700 hover:bg-purple-200">
                                    {{ $family->name }}
            ...
            <div class=" w-80 xl:w-[57rem] pt-[52px] hidden md:block">
                ...
                <div class="bg-white h-[calc(100vh-52px)] overflow-auto px-6 py-8">
                    ...
                    <div class="mb-8 flex justify-between items-center">
                        ...
                        <a href="{{ route('families.show',$family_id) }}" class="btn btn-purple">Ver mas</a>
                    </div>
