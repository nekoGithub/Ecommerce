    ...
    <x-container class="px-4 my-4">
        ...
        <nav class="flex" aria-label="Breadcrumb">
            ...
            <li>
                ...
                <a href="{{route('families.show', $category->family->id)}}" class="ms-1 text-sm font-medium text-gray-700 hover:text-purple-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">{{ $category->family->name }}</a>
                </div>
            </li>
