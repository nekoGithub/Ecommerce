...
<form action="{{ route('admin.covers.update',$cover) }}" method="POST" enctype="multipart/form-data">
    ...
    <figure class="relative mb-4">
        ...
        <img src="{{ $cover->image }}" alt="Portada" class="aspect-[3/1] w-full object-cover object-center" id="imgPreview">
    </figure>
    ...
    <div class="mb-8">
        ...
        <x-input name="title" value="{{ old('title',$cover->title) }}" class="w-full" placeholder="Por favor ingrese en titulo de la portada"/>
    </div>
    <div class="mb-8">
        <x-label>
            Fecha de incio
